...
class DrawingWidget(QWidget):
    def __init__(self, parent=None):
        ...
        self.plot_widget.setXRange(-150, 200)
        self.plot_widget.setYRange(-50, 300)
    ...
    def draw_robot(self):
        ...
        self.plot_circle(
            QPoint(self.robot.settings.LENGTHS[4], 0),
            self.robot.settings.LENGTHS[2],
            {},
        )
    ...
    def _draw_limits(self):
        ...
        self.plot_circle(
            QPoint(0, 0),
            self.robot.settings.LENGTHS[0] + self.robot.settings.LENGTHS[1],
            {"dash": [5, 5]},
        )
        self.plot_circle(
            QPoint(self.robot.settings.LENGTHS[4], 0),
            self.robot.settings.LENGTHS[2] + self.robot.settings.LENGTHS[3],
            {"dash": [30, 30]},
        )
    ...
    def on_mouse_pressed(self, event):
        ...
        if (
            event.button().name == "LeftButton" and event.button().value == 1
